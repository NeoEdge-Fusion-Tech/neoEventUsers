...
const styles = {
  ...
  list: { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '2rem', justifyItems: 'center' },
  listItem: { borderRadius: '24px', overflow: 'hidden', display: 'flex', flexDirection: 'column', height: '100%', maxWidth: '340px', width: '100%', border: '1px solid var(--glass-border)' },
  imageWrapper: { height: '170px', width: '100%', position: 'relative' },
